...
export default function Header() {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 backdrop-blur-lg border-b border-white/10 shadow-2xl">
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <Link href="/" className="flex items-center space-x-4 group flex-shrink-0">
              <div className="relative">
                <div className="bg-gradient-to-br from-amber-400 via-amber-500 to-amber-600 p-3 rounded-xl shadow-lg group-hover:shadow-amber-500/25 transition-all duration-300 group-hover:scale-105">
              ...
              <div className="hidden sm:block">
                <h1 className="text-2xl lg:text-3xl font-bold bg-gradient-to-r from-amber-400 via-amber-300 to-amber-200 bg-clip-text text-transparent">
                  Bella Vista
                </h1>
                <p className="text-amber-200/80 text-sm lg:text-base font-medium -mt-1">
                  Cocina Gourmet
                </p>
              </div>
            </Link>
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                onClick={toggleCart}
                className="relative group flex items-center bg-white/5 hover:bg-white/10 border border-white/10 hover:border-amber-400/40 rounded-xl px-4 py-3 transition-all duration-300 hover:scale-105"
              >
                <svg className="w-6 h-6 text-gray-300 group-hover:text-amber-400 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5">
                ...
                <span className="hidden md:inline ml-3 text-base font-medium text-white group-hover:text-amber-400 transition-colors duration-200">
                  Carrito
                </span>
              </button>
              ...
              <button
                ...
                className="lg:hidden flex flex-col justify-center items-center w-12 h-12 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-amber-400/40 rounded-xl transition-all duration-300 group hover:scale-105"
              >
                <span className={`h-0.5 w-6 bg-white transition-all duration-300 ${isMenuOpen ? 'rotate-45 translate-y-2' : 'mb-1.5 group-hover:w-7'}`}></span>
                <span className={`h-0.5 w-6 bg-white transition-all duration-300 ${isMenuOpen ? 'opacity-0' : 'mb-1.5 group-hover:w-5'}`}></span>
                <span className={`h-0.5 w-6 bg-white transition-all duration-300 ${isMenuOpen ? '-rotate-45 -translate-y-2' : 'group-hover:w-7'}`}></span>
              </button>
            </div>
          </div>
              ...
              <div className="bg-gradient-to-br from-white/8 to-white/[0.03] backdrop-blur-sm rounded-2xl p-6 border border-white/15 shadow-2xl">
                ...
                <div className="space-y-2 mb-6">
                  {[
                    ...
                    <Link 
                      ...
                      className="flex items-center justify-between p-4 rounded-xl text-gray-300 hover:text-white hover:bg-white/10 transition-all duration-300 group border border-transparent hover:border-white/20"
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <span className="font-medium text-lg group-hover:text-amber-400 transition-colors duration-200">Mi Carrito</span>
                  </div>
                  {itemCount > 0 && (
                ...
                <div className="space-y-3 mb-5">
                  <Link 
                    href="/pedido" 
                    onClick={() => setIsMenuOpen(false)}
                    className="w-full bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white px-6 py-4 rounded-xl text-center text-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-amber-500/30 flex items-center justify-center space-x-3 hover:scale-105"
                  >
                    <span>🚀</span>
                    <span>Ordenar Ahora</span>
                  </Link>
