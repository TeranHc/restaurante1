...
export default function ProductOptionsClientPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Navigation */}
      <nav className="border-b border-gray-200 bg-white relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 py-6 relative">
          <div className="flex items-center justify-between">
            <button
              onClick={volver}
              className="flex items-center space-x-3 text-gray-500 hover:text-gray-700 transition-all duration-200 group"
            >
            ...
            <div className="flex-1 text-center px-8">
              <div className="inline-block">
                <h1 className="text-2xl font-bold text-gray-800 mb-1">{producto.nombre}</h1>
                <div className="flex items-center justify-center space-x-2">
                  <div className="w-2 h-2 bg-blue-400 rounded-full opacity-70"></div>
                  <p className="text-gray-500 font-medium">Personalización de Producto</p>
                  <div className="w-2 h-2 bg-blue-400 rounded-full opacity-70"></div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              <div className="text-right">
                ...
                <p className="text-lg font-bold text-blue-600">${precioTotal.toFixed(2)}</p>
              </div>
          ...
          <div className="mt-6 flex items-center justify-center space-x-2">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs text-gray-400 font-medium">Seleccionando opciones</span>
          ...
          <div className="xl:w-80 xl:flex-shrink-0">
            <div className="sticky top-6 space-y-4">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-5 shadow-sm border border-blue-200">
                <div className="text-center">
                  <p className="text-blue-600 text-sm font-medium mb-1">Precio Total</p>
              ...
              {Object.keys(opcionesSeleccionadas).length > 0 && (
                <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
                  <h3 className="font-semibold text-gray-800 mb-3 text-sm">Resumen del pedido</h3>
                  <div className="space-y-2">
                    ...
                    {Object.entries(opcionesSeleccionadas).map(([opcionId, cantidad]) => {
                      ...
                      return (
                        <div key={opcionId} className="flex justify-between text-xs">
