...
export default function ProductOptionsClientPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Navigation */}
      <nav className="border-b border-slate-200 bg-white relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 py-6 relative">
          <div className="flex items-center justify-between">
            <button
              onClick={volver}
              className="flex items-center space-x-3 text-slate-600 hover:text-slate-900 transition-all duration-200 group"
            >
            ...
            <div className="flex-1 text-center px-8">
              <div className="inline-block">
                <h1 className="text-2xl font-bold text-slate-900 mb-1">{producto.nombre}</h1>
                <div className="flex items-center justify-center space-x-2">
                  <div className="w-2 h-2 bg-emerald-400 rounded-full"></div>
                  <p className="text-slate-600 font-medium">Personalización de Producto</p>
                  <div className="w-2 h-2 bg-emerald-400 rounded-full"></div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              <div className="text-right">
                ...
                <p className="text-lg font-bold text-emerald-600">${precioTotal.toFixed(2)}</p>
              </div>
          ...
          <div className="mt-6 flex items-center justify-center space-x-2">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs text-slate-500 font-medium">Seleccionando opciones</span>
